...
export const emergencyAccessList: SeedEmergencyAccess[] = [
  { id: 'ea-bitbucket-prod', name: 'Bitbucket Production Env', initial: 'B', description: 'Break-glass access to the Bitbucket production environment.', status: 'draft', maxDurationHrs: 24, maxConcurrent: 24, maxRequestsPerDay: 5, cooldownHrs: 2, createdOn: '2026-04-20T14:32:00.000Z', updatedOn: '2026-04-20T14:32:00.000Z' },
  { id: 'ea-github-staging', name: 'GitHub Staging Env', initial: 'G', description: 'Emergency access to GitHub staging.', status: 'active', riskLevel: 'critical', riskScore: 94, activeUsers: 48, maxDurationHrs: 24, maxConcurrent: 24, maxRequestsPerDay: 5, cooldownHrs: 2, createdOn: '2026-04-18T09:15:00.000Z', updatedOn: '2026-04-20T16:48:00.000Z' },
  { id: 'ea-docker-local', name: 'Docker Localhost Setup', initial: 'D', description: 'Local Docker break-glass configuration.', status: 'draft', maxDurationHrs: 12, maxConcurrent: 10, maxRequestsPerDay: 3, cooldownHrs: 1, createdOn: '2026-04-19T11:05:00.000Z', updatedOn: '2026-04-19T11:05:00.000Z' },
  { id: 'ea-azure-dev', name: 'Azure Dev Environment', initial: 'A', description: 'Emergency access to the Azure development subscription.', status: 'active', riskLevel: 'critical', riskScore: 91, activeUsers: 60, maxDurationHrs: 24, maxConcurrent: 24, maxRequestsPerDay: 5, cooldownHrs: 2, createdOn: '2026-04-15T08:40:00.000Z', updatedOn: '2026-04-20T13:22:00.000Z' },
  { id: 'ea-gitlab-test', name: 'GitLab Testing Env', initial: 'G', description: 'Break-glass access to GitLab testing.', status: 'active', riskLevel: 'high', riskScore: 74, activeUsers: 36, maxDurationHrs: 24, maxConcurrent: 20, maxRequestsPerDay: 5, cooldownHrs: 2, createdOn: '2026-04-14T15:10:00.000Z', updatedOn: '2026-04-20T10:05:00.000Z' },
  { id: 'ea-aws-qa', name: 'AWS QA Environment', initial: 'A', description: 'Emergency access to the AWS QA account.', status: 'active', riskLevel: 'high', riskScore: 66, activeUsers: 24, maxDurationHrs: 24, maxConcurrent: 20, maxRequestsPerDay: 5, cooldownHrs: 2, createdOn: '2026-04-12T07:55:00.000Z', updatedOn: '2026-04-20T18:30:00.000Z' },
  { id: 'ea-salesforce', name: 'Emergency Access Salesforce', initial: 'A', description: 'Emergency access for salesforce', status: 'active', riskLevel: 'critical', riskScore: 94, activeUsers: 24, maxDurationHrs: 24, maxConcurrent: 24, maxRequestsPerDay: 5, cooldownHrs: 2, createdOn: '2026-04-20T09:02:00.000Z', updatedOn: '2026-04-20T20:14:00.000Z' },
  { id: 'ea-bitbucket-prod-2', name: 'Bitbucket Production Env', initial: 'B', description: 'Secondary break-glass access to Bitbucket production.', status: 'active', riskLevel: 'medium', riskScore: 48, activeUsers: 12, maxDurationHrs: 24, maxConcurrent: 24, maxRequestsPerDay: 5, cooldownHrs: 2, createdOn: '2026-04-10T12:20:00.000Z', updatedOn: '2026-04-20T11:47:00.000Z' },
];
...
export const appAccounts: SeedAppAccount[] = [
  ...
  // External identities — contractors hold real accounts, which is why the list
  // has to name the applications beside the sponsor and the end date.
  { id: 'aa-arjun-okta', accountName: 'arjun.nair', email: 'arjun.nair@northwind-consulting.com', applicationId: 'app-okta', identityId: 'x-arjun', entitlementIds: ['ent-okta-user'] },
  { id: 'aa-arjun-aws', accountName: 'anair', email: 'arjun.nair@northwind-consulting.com', applicationId: 'app-aws', identityId: 'x-arjun', entitlementIds: ['ent-aws-ro'] },
  { id: 'aa-arjun-jira', accountName: 'arjun.nair', email: 'arjun.nair@northwind-consulting.com', applicationId: 'app-jira', identityId: 'x-arjun', entitlementIds: ['ent-jira-contrib'] },
  { id: 'aa-mei-flake', accountName: 'MCHEN', email: 'mei.chen@brightpath.io', applicationId: 'app-snowflake', identityId: 'x-mei', entitlementIds: ['ent-flake-read'] },
  { id: 'aa-mei-aws', accountName: 'mchen', email: 'mei.chen@brightpath.io', applicationId: 'app-aws', identityId: 'x-mei', entitlementIds: ['ent-aws-ro'] },
  { id: 'aa-tomas-sap', accountName: 'TBLUM', email: 'tomas.blum@ledgerwise.eu', applicationId: 'app-sap', identityId: 'x-tomas', entitlementIds: ['ent-sap-report'] },
  { id: 'aa-fatima-snow', accountName: 'fatima.zahra', email: 'fatima.zahra@northwind-consulting.com', applicationId: 'app-servicenow', identityId: 'x-fatima', entitlementIds: ['ent-snow-fulfiller'] },
  { id: 'aa-fatima-jira', accountName: 'fatima.zahra', email: 'fatima.zahra@northwind-consulting.com', applicationId: 'app-jira', identityId: 'x-fatima', entitlementIds: ['ent-jira-contrib'] },
  { id: 'aa-viktor-github', accountName: 'viktor-s', email: 'viktor.sorel@brightpath.io', applicationId: 'app-github', identityId: 'x-viktor', entitlementIds: ['ent-gh-write'] },
  { id: 'aa-viktor-jira', accountName: 'viktor.sorel', email: 'viktor.sorel@brightpath.io', applicationId: 'app-jira', identityId: 'x-viktor', entitlementIds: ['ent-jira-contrib'] },
  { id: 'aa-lena-sf', accountName: 'lena.vogt@partnerhub.de', email: 'lena.vogt@partnerhub.de', applicationId: 'app-salesforce', identityId: 'x-lena', entitlementIds: ['ent-sf-service'] },
];
