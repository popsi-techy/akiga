      ...
      <Section title="Guidelines">
        <DoDont
          dos={[
            ...
            'On an empty fill well, put Browse under the inbox mark and print the count and size caps on the prompt — don’t hide the limit until a twelfth file is rejected.',
          ]}
          donts={[
