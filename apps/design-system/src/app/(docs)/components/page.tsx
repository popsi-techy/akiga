...
const groups: { title: string; description: string; items: [string, string, string][] }[] = [
  {
    ...
    items: [
      ...
      ['Identity Cell', '/components/identity-cell', 'Table cell for a person or account — 28px avatar, email under the name.'],
      ...
      ['Settings', '/components/settings', 'Tenant-admin column: page, section save, stacked grey wells.'],
