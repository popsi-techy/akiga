...
export default function MyReviewsPage() {
  ...
  // Active = not started / in progress; History = completed.
  const all = rows ?? [];
  ...
  const open = (id: string) => router.push(`/iga/reviewer/sod-resolution/${id}`);
    ...
    <div className="flex h-full flex-col">
      ...
      <div className="min-h-0 flex-1">
        <DataTable<MyReviewRow>
          ...
          emptyMessage={
            tab === 'active'
              ? 'Reviews assigned to you that are not started or in progress will appear here.'
