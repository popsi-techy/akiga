...
export default function UserIdentitiesListPage() {
  ...
  const columns: Column<UserIdentityRow>[] = [
    ...
    { id: 'status', header: 'Status', sortable: true, width: 120, wrap: true, value: (r) => IDENTITY_STATUS[r.status].label, render: (r) => <StatusChip intent={IDENTITY_STATUS[r.status].intent} label={IDENTITY_STATUS[r.status].label} /> },
