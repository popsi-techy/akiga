  ...
  return (
    <div className="flex h-full flex-col">
      <div className="shrink-0 -mx-8 -mt-6 border-b border-border bg-canvas px-8 pt-4">
        <Link href={backHref} className="text-caption font-medium text-text-secondary transition-colors hover:text-text-primary">
          ← {backLabel}
        </Link>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              <div className="flex flex-wrap items-center gap-3">
                <h1 className="text-h3 font-bold leading-tight text-text-primary">{title}</h1>
                {chips}
              </div>
