 ...
 *
 * Why MUI was insufficient: CircularProgress is a spinner or a continuous ring,
 * not countable bites.
 */
export interface SetupProgressProps {
  ...
  /**
   * Which edge the count hangs off. `'end'` for a header against the action
   * group; `'start'` in a left-hand column.
   */
  align?: 'start' | 'end';
  /**
...
/**
 * Equal bites around a ring, with a gap so they stay countable. Green from
 * the first completed step — the same success fill the checklist tick uses —
 * so a done step is a done step.
 *
 * Exported so a control (the setup-guide book) can wear the same donut.
 */
